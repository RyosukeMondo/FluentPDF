...
/// </summary>
/// <remarks>
/// This abstraction enables testable navigation without depending on Avalonia controls.
...
public interface INavigationService
{
    ...
    /// </summary>
    /// <param name="pageType">The type of page to navigate to. Must be a valid Avalonia UserControl type.</param>
    ...
    /// <exception cref="InvalidOperationException">Thrown when navigation fails or ContentControl is not initialized.</exception>
