...
- [x] 1. Create API server bootstrap infrastructure
...
- [x] 2. Add CLI argument parsing for API server mode
...
- [x] 3. Create request/response DTO models
...
- [x] 4. Implement DocumentSessionManager for tracking loaded documents
...
- [x] 6. Implement Document endpoints (load/info/close)
...
- [x] 8. Implement HashingService for render verification
...
- [x] 9. Implement Verify endpoints (single and batch)
...
- [x] 10. Add middleware for correlation IDs and error handling
...
- [x] 11. Register API services in DI container
...
- [x] 12. Create API integration tests
...
- [x] 13. Create CLI verification script
...
- [x] 14. Add Swagger/OpenAPI documentation
...
- [x] 15. Update CLAUDE.md with API server documentation
