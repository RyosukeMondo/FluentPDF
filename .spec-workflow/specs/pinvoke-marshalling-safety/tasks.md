...
- [x] 10. Create marshalling verification unit tests in FluentPDF.Rendering.Tests/Interop/MarshallingVerificationTests.cs
...
- [x] 12. Add CI/CD pipeline integration in .github/workflows/build.yml
...
- [x] 14. Add verification examples to README.md
